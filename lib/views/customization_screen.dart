  ...
  void didChangeDependencies() {
    ...
    if (_formOrders.isEmpty) {
      ...
      if (order != null) {
        ...
        _formOrders['price'] = order.price;
        _formOrders['store'] = order.store;
                        ...
                        children: <Widget>[
                          Expanded(
                            child: TextFormField(
                              decoration: InputDecoration(
                                  labelText:
                                      'URL da imagem para personalização'),
                            ...
                            children: [
                              RaisedButton(
                                ...
                                color: selectedStore == 1
                                    ...
                                    : Theme.of(context).accentColor,
                                child: Text('Loja 1'),
                                onPressed: () => _formOrders['itemSelected'] !=
                                        null
